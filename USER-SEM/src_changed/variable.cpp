/* ----------------------------------------------------------------------
   ...
   ## Edited to incorporate SEM functionalities by Sandipan
------------------------------------------------------------------------- */
                              ...
                              double *argstack, int &nargstack)
{
  ...
  if (index >= 0 && index < atom->nlocal) {
    ...
    if (flag == 0) {
      ...
      else if (strcmp(word,"cell") == 0) mine = atom->cell[index];//Code change by Sandipan to incorporate cell id
      else if (strcmp(word,"cellpart") == 0) mine = atom->cell[index];//Code change by Sandipan to incorporate cellpart
...
int Variable::is_atom_vector(char *word)
{
  ...
  if (strcmp(word,"cell") == 0) return 1;//Code change by Sandipan to incorporate cell id
  if (strcmp(word,"cellpart") == 0) return 1;//Code change by Sandipan to incorporate cellpart
                           ...
                           Tree **treestack, int &ntreestack)
{
  ...
  if (strcmp(word,"id") == 0) {
   ...
   //Change by Sandipan to incorporate cell id and cellpart starts 
    else if (strcmp(word,"cell") == 0) {
    newtree->type = INTARRAY;
    newtree->nstride = 1;
    newtree->iarray = atom->cell;

  }
    else if (strcmp(word,"cellpart") == 0) {
    newtree->type = INTARRAY;
    newtree->nstride = 1;
    newtree->iarray = atom->cellpart;

  }
  //Change by Sandipan to incorporate cell id and cellpart ends  
    else if (strcmp(word,"mol") == 0) {
    if (!atom->molecule_flag)
      error->one(FLERR,"Variable uses atom property that isn't allocated");
    if (sizeof(tagint) == sizeof(smallint)) {
